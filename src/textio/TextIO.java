...
public class TextIO {
     ...
     *
     * Modified August 2020 - added the "showPrompt" behaviour to skipWhitespace. Previously,
     * skipWhitespace would show a re-prompt on empty user input. This feature is now
     * disabled by default but can be switched on if necessary using showPrompt(boolean).
     */
    ...
    /**
     * Control the presents of a "? " prompt after repeated empty user input.
     *
     * @param value enable or disable the prompt
     */
    public static void setInputPromptRepetition(boolean value) {
        isReprompting = value;
    }
    ...
    private static boolean isReprompting = false;
